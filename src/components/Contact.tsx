        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8 animate-fade-in">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Get in touch with our team of security experts. We're here to answer your questions 
                and provide customized solutions for your security needs.
              </p>
            </div>
            ...
            <div className="bg-gradient-primary p-6 rounded-lg shadow-glow">
              <h4 className="text-xl font-bold text-white mb-2">24/7 Emergency Support</h4>
              <p className="text-white/90 mb-4">
                For urgent security matters, call our emergency hotline
              </p>
              <p className="text-2xl font-bold text-white">1-800-GUARD-24</p>
            </div>
          </div>
          ...
          <div className="animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <form onSubmit={handleSubmit} className="space-y-6 bg-card p-8 rounded-xl shadow-card border border-border">
              ...
              <Button type="submit" className="w-full bg-gradient-primary shadow-glow text-lg" size="lg">
